...
public class CalendarCustomView extends LinearLayout{
    ...
    public static class CalendarActivity extends AppCompatActivity {
        private static final String TAG = xjantuli.mendelu.cz.eventcalendar.CalendarActivity.class.getSimpleName();
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            String value = intent.getStringExtra("calendar");
        }
    }
}